...
# --- Tools (Via a raw (plain text) ReAct prompt) ---
...
# tool_descriptions and tool_names will be injected in the ReAct prompt:
"""
...
# CHANGE 3: Drop tools= from client.chat(). The LLM has no idea it's an agent —
...
def run_agent(question: str):
    ...
    # CHANGE 4: One prompt string replaces the system/user message split.
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # CHANGE 5: Parse tool calls from raw text with regex — fragile if LLM doesn't follow format.
        ...
        # CHANGE 4: History is one growing string re-sent every iteration (replaces message.append).
